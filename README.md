...
The remaining figures were generated by `make_thesis_models.py` from the saved modeling output files. The final exported figures do not contain internal plot titles, because figure titles are provided in the thesis document itself.
